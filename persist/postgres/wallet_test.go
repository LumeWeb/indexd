...
func TestSingleAddressWalletStore(t *testing.T) {
	store := initPostgres(t, zaptest.NewLogger(t).Named("postgres"))

	for _, m := range []struct {
		method string
		test   func(*Store) func(*testing.T)
	}{
		{"Tip", testSingleAddressWalletStoreTip},
		{"UnspentSiacoinElements", testSingleAddressWalletStoreUnspentSiacoinElements},
		{"WalletEvents/WalletEventCount", testSingleAddressWalletStoreWalletEventsAndWalletEventCount},
	} {
		t.Run(m.method, m.test(store))
	}
}

func testSingleAddressWalletStoreTip(store *Store) func(t *testing.T) {
...
func testSingleAddressWalletStoreUnspentSiacoinElements(store *Store) func(t *testing.T) {
	return func(t *testing.T) {
...
func testSingleAddressWalletStoreWalletEventsAndWalletEventCount(store *Store) func(t *testing.T) {
	return func(t *testing.T) {
