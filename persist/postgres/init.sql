...
CREATE INDEX contracts_host_id_good_state_remaining_allowance_partial_idx ON contracts (host_id, good, state, remaining_allowance DESC) WHERE good = true AND remaining_allowance > 0 AND state <= 1; -- for fetching contracts for funding
