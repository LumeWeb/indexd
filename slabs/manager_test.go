...
func (s *mockStore) Object(ctx context.Context, account proto.Account, key types.Hash256) (LockedObject, error) {
	return LockedObject{}, nil
}
...
func (s *mockStore) SaveObject(ctx context.Context, account proto.Account, obj LockedObject) error {
	return nil
}

func (s *mockStore) ListObjects(ctx context.Context, account proto.Account, cursor Cursor, limit int) ([]LockedObject, error) {
	return nil, nil
}
