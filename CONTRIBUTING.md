...
Thank you for considering contributing to `indexd`! We welcome your contributions
...
To get started, fork the indexd repository to your GitHub account. This will
...
`indexd` uses [golangci-lint](https://golangci-lint.run/usage/install/) to lint.
